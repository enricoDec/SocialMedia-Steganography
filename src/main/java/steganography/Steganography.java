...
public interface Steganography {
    ...
    /**
     * <p>Tests whether the given data has a hidden message encoded in it. This method only works if the message was
     * encoded
     ...
     * you need to test a lot of possible steganographicData, just use decode(...) and catch the
     * UnknownStegFormatException</p>
     *
